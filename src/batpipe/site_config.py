...
class SiteConfig:
    ...
    noise_reduction_percentile: float = 30.0
    noise_reduction_spectral_subtract_oversubtract: float = 4.0
    noise_reduction_spectral_subtract_floor_ratio: float = 0.002
    noise_reduction_spectral_subtract_smoothing_bins: int = 9
...
def load_site_config(path: Path) -> SiteConfig:
    ...
    return SiteConfig(
        ...
        noise_reduction_percentile=float(payload.get("noise_reduction_percentile", 30.0)),
        noise_reduction_spectral_subtract_oversubtract=float(payload.get("noise_reduction_spectral_subtract_oversubtract", 4.0)),
        noise_reduction_spectral_subtract_floor_ratio=float(payload.get("noise_reduction_spectral_subtract_floor_ratio", 0.002)),
        noise_reduction_spectral_subtract_smoothing_bins=int(payload.get("noise_reduction_spectral_subtract_smoothing_bins", 9)),
