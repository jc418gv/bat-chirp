...
class ReviewSiteTests(unittest.TestCase):
    def test_build_review_site_writes_html_pages_with_spectrogram_links(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("compare spectrograms", html)
            self.assertIn("data-spectrogram-compare-src=\"20260518_020000T/spectrogram_noise_reduced_020000.png\"", html)
            self.assertIn("open compare image", html)
