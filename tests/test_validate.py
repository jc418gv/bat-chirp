...
class ValidateTests(unittest.TestCase):
    ...
    def test_estimate_candidate_train_range_extends_to_nearby_peaks(self) -> None:
    ...
    def test_estimate_candidate_train_range_keeps_multiple_segments_near_anchor(self) -> None:
